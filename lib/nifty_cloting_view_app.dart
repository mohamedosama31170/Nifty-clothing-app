...
class NiftyClothingWebViewApp extends StatefulWidget {
  const NiftyClothingWebViewApp({super.key});

  @override
  State<NiftyClothingWebViewApp> createState() => _NiftyClothingWebViewAppState();
}

class _NiftyClothingWebViewAppState extends State<NiftyClothingWebViewApp> {
